...
-- VERSÃO CORRIGIDA - compatível com limite de chave 767 bytes
...
-- Permite índices maiores (necessário em alguns servidores)
...
-- Usuários (varchar(191) nas colunas com UNIQUE KEY — limite utf8mb4)
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `isActive` tinyint(1) NOT NULL DEFAULT 1,
  `govBrId` varchar(191) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `processes` (
  ...
  `externalEmail` varchar(191) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `signatures` (
  ...
  `govBrProtocol` varchar(191) DEFAULT NULL,
...
(UUID(), 'sla_alert_days',     '3',                       'Dias antes do vencimento p/ alertar', NOW());
...
INSERT IGNORE INTO `departments` (`id`, `name`, `code`, `description`, `parentId`, `isActive`, `createdAt`, `updatedAt`) VALUES
...
-- Tipos de processo
INSERT IGNORE INTO `process_types` (`id`, `name`, `code`, `description`, `requiresSignature`, `slaDays`, `isPublic`, `isActive`, `createdAt`) VALUES
...
INSERT IGNORE INTO `protocol_counters` (`id`, `year`, `sequence`) VALUES (UUID(), YEAR(NOW()), 0);

-- Usuários iniciais (hashes bcrypt gerados, custo 12)
-- Senha admin@agildoc.com.br   → Admin@123
-- Senha gestor@agildoc.com.br  → Gestor@123
-- Senha servidor@agildoc.com.br → Servidor@123
INSERT IGNORE INTO `users` (`id`, `name`, `email`, `cpf`, `password`, `role`, `departmentId`, `isActive`, `createdAt`, `updatedAt`) VALUES
